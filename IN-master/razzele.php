...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (!empty($First) && !empty($Last) && !empty($USN) && !empty($Email) && !empty($Mobile) && !empty($Gender) && !empty($SelectyourBranch)) {
        ...
        $query = "INSERT INTO `razzele3` (`FirstName`, `LastName`, `USN`, `Email`, `Mobile`, `Gender`, `Branch`, `Semester`) VALUES ('$First', ' $Last', '$USN', '$Email', '$Mobile', '$Gender', '$SelectyourBranch', '$Selectcurrentsemester')";
        if ($query) {
    ...
    <div class="container">
        <div class="row register">
            ...
            <div class="col-sm-6 reg">
                <form class="form-horizontal hr" method="post" action="razzele.php">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="usn" class="form-control" id="usn" placeholder="Enter your usn">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <Gender class="control-label col-sm-4" for="mob">Mobile</label>
                            <div class="col-sm-8">
