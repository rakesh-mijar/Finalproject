...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (!empty($First) && !empty($Last) && !empty($USN) && !empty($Email) && !empty($Mobile) && !empty($Gender) && !empty($SelectyourBranch)) {
        ...
        $query = "INSERT INTO `csi` (`FirstName`, `LastName`, `USN`, `Email`, `Mobile`, `Gender`, `Branch`, `Semester`) VALUES ('$First', ' $Last', '$USN', '$Email', '$Mobile', '$Gender', '$SelectyourBranch', '$Selectcurrentsemester')";
        if ($query) {
    ...
    <div class="container">
        <div class="row register">
            ...
            <div class="col-sm-6 reg">
                <form class="form-horizontal hr" method="post" action="csi.php">

                    <div class="form-group">
                        <label class="control-label col-sm-4" for="fname">First Name </label>
                        <div class="col-sm-8">
                            <input type="text" name="fname" class="form-control" id="uname" placeholder="Enter your First Name" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="lname" class="form-control" id="uname" placeholder="Enter your LastName" required />
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="usn" class="form-control" id="uname" maxlength="10" pattern="\d{1}[A-Za-z]{2}\d{2}[a-zA-Z]{2}\d{3}" placeholder="Enter your usn" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="umail" class="form-control" id="uname" placeholder="Enter your mail" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <Gender class="control-label col-sm-4" for="mob">Mobile Number </label>
                            <div class="col-sm-8">
                                ...
                                <!--<input type="number" name="mob" title="Error Message" id="uname" pattern="[1-9]{10}" minlength="10">-->
                                <input type="text" name="mob" maxlength="10" pattern="\d{10}" title="Please enter exactly 10 digits" />
                            </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-4 col-sm-8">
                            <a href="Msg.php"><button type="submit" class="btn btn-primary">Register</button></a>
                        </div>
                    </div>
                </form>
            </div>
